    ...
    axios.get(`https://soi-tcvtool.xyz/truyencv/member/${toId}`).then(
        response => { 
            ...
            if (name !== '' && bp === 'Chưa gia nhập bang phái') {
                chat(`${fromName} - Chuyển ${formatBac(amount)} số dư ([color=red]Không phải bạc[/color]) cho ${name} ([url=https://tutien.net/member/${toId}]${toId}[/url]) - [color=red]Không có bang[/color] (Y/N)?[br][Phí dịch vụ: ${phiChuyen} bạc][br][color=red]Giao dịch này cần chờ 5s để xác nhận[/color]`);
                setTimeout(function () {
            ...
            if (name !== '' && bp !== 'Vô Cực Ma Tông') {
                chat(`${fromName} - Chuyển ${formatBac(amount)} số dư ([color=red]Không phải bạc[/color]) cho ${name} ([url=https://tutien.net/member/${toId}]${toId}[/url]) - [color=red]Không thuộc bang Vô Cực[/color] (Y/N)?[br][Phí dịch vụ: ${phiChuyen} bạc][br][color=red]Giao dịch này cần chờ 5s để xác nhận[/color]`);
                setTimeout(function () {
                    setItem(queueKeyRuong, queueDataRuong);
                    setExpire(queueKeyRuong, 15); 
                }, 5000); 
            ...
            if (name !== '' && bp === 'Vô Cực Ma Tông') {
                setItem(queueKeyRuong, queueDataRuong);
                setExpire(queueKeyRuong, 15);
                pmCbox(fromCboxId, `Chuyển ${formatBac(amount)} số dư ([color=red]Không phải bạc[/color]) cho ${name} ([url=https://tutien.net/member/${toId}]${toId}[/url]) (Y/N)?[br]Số dư còn lại: ${formatBac(soDu)} [Phí dịch vụ: ${phiChuyen} bạc]`);
            }
         }
       )
       .catch(error => {
    ...
    */
    ...
    axios.get(`https://soi-tcvtool.xyz/truyencv/member/${toId}`).then(
        response => {
            ...
            if (name !== '' && bp === 'Chưa gia nhập bang phái') {
                chat(`${fromName} - Chuyển ${formatBac(amount)} bạc cho ${name} ([url=https://tutien.net/member/${toId}]${toId}[/url]) - [color=red]Không có bang[/color] (Y/N)?[br][Phí dịch vụ: ${phiChuyen} bạc][br][color=red]Giao dịch này cần chờ 5s để xác nhận[/color]`);
                setTimeout(function () {
                    setItem(queueKey, queueData);
                    setExpire(queueKey, 15);  
                }, 5000);
            ...
            if (name !== '' && bp !== 'Vô Cực Ma Tông') {
                chat(`${fromName} - Chuyển ${formatBac(amount)} bạc cho ${name} ([url=https://tutien.net/member/${toId}]${toId}[/url]) - [color=red]Không thuộc bang Vô Cực[/color] (Y/N)?[br][Phí dịch vụ: ${phiChuyen} bạc][br][color=red]Giao dịch này cần chờ 5s để xác nhận[/color]`);
                setTimeout(function () {
                    setItem(queueKey, queueData);
                    setExpire(queueKey, 15); 
                }, 5000); 
            ...
            if (name !== '' && bp === 'Vô Cực Ma Tông') {
                setItem(queueKey, queueData);
                setExpire(queueKey, 15);
                pmCbox(fromCboxId, `Chuyển ${formatBac(amount)} bạc cho ${name} ([url=https://tutien.net/member/${toId}]${toId}[/url]) (Y/N)?[br]Số dư còn lại: ${formatBac(soDu)} [Phí dịch vụ: ${phiChuyen} bạc]`); 
            }
        })
        .catch(error => {
